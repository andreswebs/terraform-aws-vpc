...
| <a name="input_default_max_azs"></a> [default\_max\_azs](#input\_default\_max\_azs) | Default maximum number of availability zones selected in case none as specified | `number` | `3` | no |
